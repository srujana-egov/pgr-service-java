...
dependencies {
    testImplementation(project(":pgr-service-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../pgr-service-java-core/src/main/resources/META-INF/proguard/pgr-service-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.pgr_service.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../pgr-service-java-core/src/main/resources/META-INF/proguard/pgr-service-java-core.pro",
