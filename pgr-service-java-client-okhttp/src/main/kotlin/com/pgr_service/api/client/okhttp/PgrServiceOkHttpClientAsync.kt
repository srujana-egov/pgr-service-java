...
package com.pgr_service.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.pgr_service.api.client.PgrServiceClientAsync
import com.pgr_service.api.client.PgrServiceClientAsyncImpl
import com.pgr_service.api.core.ClientOptions
import com.pgr_service.api.core.Sleeper
import com.pgr_service.api.core.Timeout
import com.pgr_service.api.core.http.Headers
import com.pgr_service.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [PgrServiceClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class PgrServiceOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [PgrServiceClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): PgrServiceClientAsync = builder().fromEnv().build()
    }

    /** A builder for [PgrServiceOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.pgr_service.api.core.jsonMapper]. The default is usually sufficient and
        ...
        /**
         * Returns an immutable instance of [PgrServiceClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PgrServiceClientAsync =
            PgrServiceClientAsyncImpl(
                clientOptions
                    .httpClient(
