...
import com.pgr_service.api.client.PgrServiceClientImpl
...
/**
 * A class that allows building an instance of [PgrServiceClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class PgrServiceOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [PgrServiceClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): PgrServiceClient = builder().fromEnv().build()
    }

    /** A builder for [PgrServiceOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [PgrServiceClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PgrServiceClient =
            PgrServiceClientImpl(
                clientOptions
                    .httpClient(
